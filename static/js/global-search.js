...
export const GlobalSearch = {
    ...
    init() {
        // Button is now in HTML directly, so we just set up the dialog
            ...
            html += `<div>
                ...
                <div class="${isExpanded ? '' : 'hidden'}" style="padding:2px 0">
                    ${matches.map(m => {
                        ...
                        return `
                        <div class="gs-match" data-file="${esc(file)}" data-line="${m.line}" style="display:flex;gap:8px;padding:3px 12px 3px 28px;cursor:pointer">
